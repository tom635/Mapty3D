...
namespace Mapzen
{
    public class RegionMap : MonoBehaviour
    {
        ...
        public TileArea Area = new TileArea(
            new LngLat(28.4917178, 77.0619388),
            new LngLat(28.8117178, 77.3819388),
            16);
        ...
        {
            return new TileArea(new LngLat(Convert.ToDouble(boundingBox[0]), Convert.ToDouble(boundingBox[2])), new LngLat(Convert.ToDouble(boundingBox[1]), Convert.ToDouble(boundingBox[3])), 20);
        }
        ...
        public void DownloadTilesAsync(TileArea Area)
        {
            Debug.Log("Downloading titles");
            TileBounds bounds = new TileBounds(Area);
